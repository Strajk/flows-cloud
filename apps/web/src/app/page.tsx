    ...
    <div className="container">
      ...
      <main>
        ...
        <div className="conditional-step mb80">
          ...
          <p>
            With conditional steps, you can show different steps based on the
            user&apos;s input, their segmentation, or any other condition.
            Conditional flows are infinitely nestable and can be used to create
            complex flows.
          </p>
        </div>
        <div className="wait-step mb80">
          ...
          <p>
            Wait steps are useful for giving users time to complete a task
            before showing the next step. You can wait for a specific amount of
            time or until the user completes a specific action. Then the flow
        ...
        <div className="mb80">
          ...
          <p>
            Call steps are versatile steps that can be used to trigger any
            action such as opening a dropdown menu, changing a state in UI, or
            anything else that you can do with JavaScript. Call steps give you
            the control to create any flow you can imagine.
          </p>
        </div>
        <div className="mb80">
